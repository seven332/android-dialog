...
public class LongMessageDialog extends MessageDialog {
  ...
  public LongMessageDialog(boolean header, boolean footer) {
    super(header, footer);
  }

  @Keep
  public LongMessageDialog(Bundle bundle) {
    super(bundle);
  }

  @Override
  protected String getTitle() {
    return Constants.LONG_MESSAGE_TITLE;
  }

  @Override
  protected String getMessage() {
    return Constants.LONG_MESSAGE;
  }
}
