...
public class LongMultiChoiceDialog extends MultiChoiceDialog {

  public LongMultiChoiceDialog(boolean header, boolean footer) {
    super(header, footer);
  }

  public LongMultiChoiceDialog(Bundle bundle) {
    super(bundle);
  }
